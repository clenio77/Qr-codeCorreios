...
// Isso permite que o app carregue mais rápido em visitas subsequentes em produção e dá
// capacidades offline. No entanto, também significa que os desenvolvedores (e usuários)
// só verão atualizações implantadas em visitas subsequentes a uma página, depois que todas
// as guias existentes abertas na página forem fechadas, pois os recursos em cache anteriormente
    ...
    window.addEventListener('load', () => {
      ...
      if (isLocalhost) {
        ...
        navigator.serviceWorker.ready.then(() => {
          console.log(
            'Este aplicativo web está sendo servido em cache primeiro por um service ' +
